...
//     price: 15,
//     image:
//       "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdSEfb1OmAsMMgiIXeR-ZtXh74byco_Lr-yg&s",
//   },
// ];
...
for (const element of usersList) {
  wrapper.innerHTML +=`
    ...
    <h2>ID – ${element.id} NAME – ${element.username}</h2>
    <h3>EMAIL – ${element.phone}</h3>
